...
class TestParseSpeciesAuthor:
    def test_parse_species_author(self):
        ...
        species_authors = [
            ...
            ["epi (Auth) (?)", ["epi", None, "(Auth)"], ["uncertain det."]],
            ["nr. foo", ["sp. nr. foo", None, None], []],
            ["cf. foo", [None, None, None], ["sp. cf. foo"]],
            ["n. sp.", ["n. sp.", None, None], []],
            ["?n. sp.", [None, None, None], []],
            ...
            ["infernalis n. subsp.", ["infernalis", "n. subsp.", None], ["n. subsp."]],
            ["n.sp. T, n.ssp. C", ["n. sp.", None, None], ["n. sp. T, n. ssp. C"]],
            ...
            ["sp. near viator", ["sp. nr. viator", None, None], []],
            ["sp. nr. baronia", ["sp. nr. baronia", None, None], []],
